...
import {SymbolExcellanceStyled} from './Symbol-Of-Excellance.js';

const SymbolOfExcellanceComponent = () => {
    return(
        <SymbolExcellanceStyled>
...
export default SymbolOfExcellanceComponent;
